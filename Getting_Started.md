...
```mermaid
graph TD
    Start["Entry Point Decision"] --> HelpDesk["IT Support: $45k-$55k"]
    Start --> JrDev["Junior Developer: $60k-$85k"]
    Start --> DataAnalyst["Data Analyst: $55k-$70k"]
    Start --> Bootcamp["Coding Bootcamp Investment"]
    
    HelpDesk --> SysAdmin["System Admin: $65k-$85k"]
    HelpDesk --> NetAdmin["Network Admin: $70k-$90k"]
    
    SysAdmin --> CloudEng["Cloud Engineer: $90k-$130k"]
    SysAdmin --> DevOps["DevOps Engineer: $120k-$165k"]
    NetAdmin --> CloudEng
    NetAdmin --> SecAnalyst["Security Analyst: $75k-$105k"]
    
    SecAnalyst --> SecEng["Security Engineer: $110k-$150k"]
    
    JrDev --> MidDev["Mid-Level Developer: $90k-$130k"]
    Bootcamp --> JrDev
    
    MidDev --> SrDev["Senior Developer: $130k-$180k"]
    MidDev --> DevOps
    
    DataAnalyst --> DataSci["Data Scientist: $95k-$140k"]
    DataSci --> MLEng["AI/ML Engineer: $135k-$210k"]
    
    SrDev --> StaffEng["Staff/Principal Engineer: $160k-$250k+"]
    SrDev --> Architect["Solutions/Cloud Architect: $145k-$185k+"]
    
    CloudEng --> Architect
    DevOps --> Architect
    
    SecEng --> SecArch["Security Architect: $140k-$200k+"]
    
    StaffEng --> TechLead["Technical Leadership Track"]
    Architect --> TechLead
    
    SysAdmin --> ITMgr["IT Manager: $128k-$178k"]
    ITMgr --> Director["IT Director: $150k-$220k+"]
    
    style HelpDesk fill:#e1f5ff
    style JrDev fill:#e1f5ff
    style DataAnalyst fill:#e1f5ff
    style Bootcamp fill:#fff3cd
    style Start fill:#f8f9fa
    style StaffEng fill:#d4edda
    style Architect fill:#d4edda
    style MLEng fill:#d4edda
    style SecArch fill:#d4edda
    style Director fill:#d4edda
```
